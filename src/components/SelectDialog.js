...
import {View, Text, ScrollView, StyleSheet, TouchableOpacity, Image, ImageBackground, Platform, StatusBar} from "react-native";
...
export default class SelectDialog extends Component {
  ...
  _renderHeader() {
    return (
      <View style={{width: '100%', height: size(80), justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(68, 180, 233, 1)'}}>
        <Text style={{color: 'white', fontSize: size(32), fontWeight: 'bold'}}>{this.state.title}</Text>
      </View>
    )
  }
          ...
          <View style={{width: '100%', height: size(80)}}>
            <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', flex: 1}}>
              ...
              </Text>
              {
                isSelect
                  ?
                  <Image source={require('../img/dialog_check.png')} style={{width: size(36), height: size(36), marginRight: size(20)}}/>
                  :
                  null
              }
            </View>
      ...
      <View style={{width: '100%', height: size(80), flexDirection: 'row'}}>
        <TouchableOpacity style={{flex: 1}} activeOpacity={1} onPress={() => {this.setState({isShow: false})}}>
          <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'white'}}>
            <Text style={{color: 'rgba(68, 180, 233, 1)', fontSize: size(32), fontWeight: 'bold'}}>取消</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={{flex: 1}} activeOpacity={1} onPress={() => {this.confirmResult()}}>
          <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(68, 180, 233, 1)'}}>
            <Text style={{color: 'white', fontSize: size(32), fontWeight: 'bold'}}>确定</Text>
          </View>
        </TouchableOpacity>
      </View>
    )
